...
function triangulate(p) {
  ...
  const tgs = [];
  const avl = [];
  for (let i2 = 0; i2 < n2; i2++) avl.push(i2);
  let i = 0;
  let al = n2;
  while (al > 3) {
    const i0 = avl[(i + 0) % al];
...
var Narrowphase = class {
  ...
  constructor() {
     ...
     * @returns
     */
    __publicField(this, "convexLine", /* @__PURE__ */ (() => function(_convexBody, _convexShape, _convexOffset, _convexAngle, _lineBody, _lineShape, _lineOffset, _lineAngle, _justTest) {
      return 0;
    })());
    /**
     ...
     * @returns
     */
    __publicField(this, "lineBox", /* @__PURE__ */ (() => function(_lineBody, _lineShape, _lineOffset, _lineAngle, _boxBody, _boxShape, _boxOffset, _boxAngle, _justTest) {
      return 0;
    })());
    /**
     ...
     * @returns
     */
    __publicField(this, "convexCapsule", /* @__PURE__ */ (() => {
      var _this = this;
     ...
     * @returns
     */
    __publicField(this, "lineCapsule", /* @__PURE__ */ (() => function(_lineBody, _lineShape, _linePosition, _lineAngle, _capsuleBody, _capsuleShape, _capsulePosition, _capsuleAngle, _justTest) {
      return 0;
    })());
    /**
     ...
     * @returns
     */
    __publicField(this, "capsuleCapsule", /* @__PURE__ */ (() => {
      var _this2 = this;
     ...
     * @returns
     */
    __publicField(this, "lineLine", /* @__PURE__ */ (() => function(_bodyA, _shapeA, _positionA, _angleA, _bodyB, _shapeB, _positionB, _angleB, _justTest) {
      return 0;
    })());
    /**
     ...
     * @returns
     */
    __publicField(this, "planeLine", /* @__PURE__ */ (() => {
      var _this3 = this;
     ...
     * @returns
     */
    __publicField(this, "particleCapsule", /* @__PURE__ */ (() => {
      var _this4 = this;
     ...
     * @returns
     */
    __publicField(this, "circleLine", /* @__PURE__ */ (() => {
      var _this5 = this;
     ...
     * @returns
     */
    __publicField(this, "circleCapsule", /* @__PURE__ */ (() => {
      var _this6 = this;
      return function(bi, si, xi, ai, bj, sj, xj, aj, justTest) {
        if (justTest === void 0) {
          justTest = false;
     ...
     * @returns
     */
    __publicField(this, "circleConvex", /* @__PURE__ */ (() => {
      var _this7 = this;
     ...
     * @returns
     */
    __publicField(this, "particleConvex", /* @__PURE__ */ (() => {
      var _this8 = this;
     ...
     * @returns
     */
    __publicField(this, "circleCircle", /* @__PURE__ */ (() => {
      var _this9 = this;
     ...
     */
    __publicField(this, "planeConvex", /* @__PURE__ */ (() => {
      var _this10 = this;
     ...
     * @returns
     */
    __publicField(this, "particlePlane", /* @__PURE__ */ (() => {
      var _this11 = this;
    ...
    __publicField(this, "circleParticle", /* @__PURE__ */ (() => {
      var _this12 = this;
     ...
     * @returns
     */
    __publicField(this, "planeCapsule", /* @__PURE__ */ (() => {
      var _this13 = this;
     ...
     * @returns
     */
    __publicField(this, "circlePlane", /* @__PURE__ */ (() => {
      var _this14 = this;
     ...
     * @returns
     */
    __publicField(this, "convexConvex", /* @__PURE__ */ (() => {
      var _this15 = this;
     ...
     * @returns
     */
    __publicField(this, "circleHeightfield", /* @__PURE__ */ (() => {
      var _this16 = this;
     ...
     * @returns
     */
    __publicField(this, "convexHeightfield", /* @__PURE__ */ (() => {
      var _this17 = this;
